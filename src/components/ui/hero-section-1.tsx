...
function buttonClasses(variant: "default" | "outline" | "ghost", size: "sm" | "lg") {
  const base =
...
function ButtonLink({
  ...
  return (
    <a href={href} className={cn(buttonClasses(variant, size), className)}>
      {children}
    </a>
  );
}
...
const transitionVariants: VariantsPair = {
  item: {
  ...
  return (
    <>
      ...
      <main className="relative overflow-hidden">
        <div className="absolute bottom-160  inset-0  pointer-events-none">
  <Threads amplitude={1.5} enableMouseInteraction color={[1, 1, 4]} distance={0.4} />
</div>
              ...
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  >
                    ...
                    <span className="bg-background group-hover:bg-muted size-6 overflow-hidden rounded-full duration-500">
