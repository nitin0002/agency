...
const contactMethods = [
  {
    ...
    gradient: "from-black/20 to-black/10",
    hoverColor: "blue"
  },
  {
    icon: Phone,
...
export function PremiumContact() {
  ...
  return (
    <section className="relative py-32 text-black overflow-hidden">
      ...
      >
        ...
        >
          <motion.div
            className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/[0.08] border border-white/[0.15] backdrop-blur-sm mb-6 shadow-lg"
          ...
          <motion.h2 
            ...
            variants={fadeInUp}
          >
            <span className="bg-clip-text text-transparent bg-gradient-to-t from-black to-black/40">
              Get in
            </span>
            <br />
            <motion.span 
              className="bg-clip-text text-transparent bg-[#010104]"
              animate={{
        ...
        >
          {companyStats.map((stat, index) => (
            <motion.div
              key={index}
              className="text-center p-6 bg-white/[0.05] backdrop-blur-xl rounded-2xl border border-black/[0.15] group hover:bg-white/[0.08] transition-all"
        ...
        <div className="flex items-center justify-between mb-12 lg:px-64">
              ...
              {!isSubmitted ? (
                ...
                >
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="relative border border-black/20 rounded-xl">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-4 py-4 bg-white/[0.08] border rounded-xl text-black placeholder-black/40 focus:outline-none focus:border-indigo-400 transition-all ${
                  ...
                  <div className="relative border border-black/20 rounded-xl">
                    <Building className="absolute left-3 top-1/2 transform -translate-y-1/2 h-5 w-5 text-black/40" />
                    <input
                      type="text"
                      placeholder="Company (Optional)"
                      value={formData.company}
                      onChange={(e) => handleInputChange('company', e.target.value)}
                      className="w-full pl-10 pr-4 py-4 bg-white/[0.08] border border-white/[0.15] rounded-xl text-black placeholder-black/40 focus:outline-none focus:border-indigo-400 transition-all"
                    />
                  </div>
                  ...
                  <div className="relative border border-black/20 rounded-xl">
                    ...
                    <textarea
                      ...
                      className={`w-full pl-10 pr-4 py-4 bg-white/[0.08] border rounded-xl text-black placeholder-black/40 focus:outline-none focus:border-indigo-400 transition-all resize-none ${
                  ...
                  <motion.button
                    ...
                    className="w-full relative group overflow-hidden bg-gradient-to-r from-blue-800/60 to-blue-800/60 hover:from-blue-800/80 hover:to-blue-800/80 text-black font-medium py-4 px-6 rounded-xl transition-all disabled:opacity-50"
                ...
                >
                  ...
                  <motion.button
                    ...
                    className="px-6 py-3 bg-white/[0.08] border border-white/[0.15] rounded-xl text-black hover:bg-white/[0.12] transition-all"
          ...
          >
            <div>
              <h3 className="text-3xl font-bold text-black mb-4">Other ways to reach us</h3>
              <p className="text-black/60 text-lg">
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <h4 className="text-xl font-semibold text-black mb-1">{method.title}</h4>
            ...
            <motion.div
              ...
              variants={fadeInUp}
            >
              <h4 className="text-lg font-semibold text-black mb-3">Quick Response Guarantee</h4>
